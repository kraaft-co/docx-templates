 ...
 */
var isNodeInsideTableCell = function (node) {
    var parentNode = node._parent;
 ...
 */
var isInTableCellLoop = function (ctx) {
    return ctx.loops.some(function (loop) { return loop.isTableCellLoop === true; });
};
function walkTemplate(data, template, ctx, processor) {
    return __awaiter(this, void 0, void 0, function () {
        var out, nodeIn, nodeOut, move, deltaJump, errors, loopCount, maximumWalkingDepth, _loop_1, state_1, err, innermost_loop, err;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    errors = [];
                    loopCount = 0;
                    maximumWalkingDepth = ((_a = ctx.options) === null || _a === void 0 ? void 0 : _a.maximumWalkingDepth) || 1000000;
                    _loop_1 = function () {
                        var curLoop, nextSibling, parent_3, tag, fRemoveNode, buffers, buffers, hasDrawingElements_1, nodeOutParent, imgNode, captionNodes, parent_4, linkNode, parent_5, htmlNode, parent_6, tag, newNode, newNodeTag, parent_7, result;
                        var _c;
                                ...
                                case 0:
                                    ...
                                    if (move !== 'DOWN') {
                                        ...
                                        if (tag === 'w:p' && fRemoveNode) {
                                            hasDrawingElements_1 = function (node) {
                                                if (node._fTextNode)
                                                    return false;
                                                if (node._tag === 'wp:anchor' ||
                                                    node._tag === 'wp:inline' ||
                                                    node._tag === 'w:drawing') {
                                                    return true;
                                                }
                                                return node._children.some(hasDrawingElements_1);
                                            };
                                            fRemoveNode = !hasDrawingElements_1(nodeOut);
                                        }
                                    ...
                                    if (move === 'UP') {
                                        ...
                                        if (ctx.pendingImageNode &&
                                            ...
                                            if (parent_4) {
                                                ...
                                                if (captionNodes) {
                                                    (_c = parent_4._children).push.apply(_c, captionNodes);
                                                }
                                    ...
                                    if (!(move === 'DOWN' || move === 'SIDE')) return [3 /*break*/, 3];
                                    ...
                                    if (!(nodeIn._fTextNode &&
                                        parent_7 &&
                                        !parent_7._fTextNode &&
                                        parent_7._tag === 'w:t')) return [3 /*break*/, 2];
