    ...
    it('Correctly finds the main document xml file in a regular .docx file', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    zip = _a.sent();
                    return [4 /*yield*/, (0, main_1.readContentTypes)(zip)];
                case 3:
                    content_types = _a.sent();
                    main_doc = (0, main_1.getMainDoc)(content_types);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    template = _b.sent();
                    _a = expect;
                    return [4 /*yield*/, (0, main_1.getMetadata)(template)];
                case 2:
    ...
    it('returns 0 when doc contains no images', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    template = _a.sent();
                    return [4 /*yield*/, (0, main_1.parseTemplate)(template)];
                case 2:
                    jsTemplate = (_a.sent()).jsTemplate;
                    expect((0, processTemplate_1.findHighestImgId)(jsTemplate)).toBe(3);
                    return [2 /*return*/];
            }
        });
    }); });
});
describe('preprocessTemplate delimiter matching', function () {
    ...
    // character(s).
    it('does not inject spaces when a speculative delimiter match spans paragraph breaks and then fails', function () { return __awaiter(void 0, void 0, void 0, function () {
        var template, report, zip, doc, texts;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'trailingDelimiterPrefixMatch.docx'))];
                case 1:
                    template = _a.sent();
                ...
                case 2:
                    report = _a.sent();
                    return [4 /*yield*/, (0, zip_1.zipLoad)(report)];
                case 3:
                    zip = _a.sent();
                    return [4 /*yield*/, (0, zip_1.zipGetText)(zip, 'word/document.xml')];
                case 4:
                    doc = _a.sent();
                    texts = doc
                        ? Array.from(doc.matchAll(/<w:t[^>]*>([^<]*)<\/w:t>/g)).map(function (m) { return m[1]; })
                        : [];
