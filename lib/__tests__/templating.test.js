    ...
    describe("".concat(sbStatus), function () {
        describe('Template processing', function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, (0, index_1.createReport)(options, 'JS')];
                        case 2:
                            result = _a.sent();
                            expect(result).toMatchSnapshot();
                            return [2 /*return*/];
                                            ...
                                            switch (_a.label) {
                                                ...
                                                case 1:
                                                    ...
                                                    return [2 /*return*/, {
                                                            ...
                                                            data: data,
                                                            extension: '.gif',
                                                            alt: "qr code for ".concat(contents),
                                                        }];
                                            }
                                        });
                                    }); },
            ...
            it('3A Processes HTML commands', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, opts, _a, zip, _b, _c;
                var _d;
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 2:
                            _a.apply(void 0, [_e.sent()]).toMatchSnapshot();
                            _c = (_b = jszip_1.default).loadAsync;
                            return [4 /*yield*/, (0, index_1.createReport)(opts)];
                        case 3: return [4 /*yield*/, _c.apply(_b, [_e.sent()])];
                        case 4:
                            zip = _e.sent();
                            expect(Object.keys((_d = zip === null || zip === void 0 ? void 0 : zip.files) !== null && _d !== void 0 ? _d : {})).toStrictEqual([
                                '[Content_Types].xml',
                                '_rels/.rels',
            ...
            it('40 Throws on invalid command', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            template = _a.sent();
                            return [2 /*return*/, expect((0, index_1.createReport)({
                                    noSandbox: noSandbox,
                                    template: template,
                                    data: {
                                        companies: [
            ...
            it('regression test for issue #133 (and #83): LINK inside FOR loop', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, opts, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'link-regression-issue-133.docx'))];
                        case 1:
                            template = _b.sent();
                            opts = {
                                noSandbox: noSandbox,
            ...
            it('HTML in table (see PR #233)', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'tableWithHTML.docx'))];
                        case 1:
                            template = _b.sent();
                            _a = expect;
                            return [4 /*yield*/, (0, index_1.createReport)({
            ...
            it('INS in header and footer', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'insertInHeaderAndFooter.docx'))];
                        case 1:
                            template = _b.sent();
                            _a = expect;
                            return [4 /*yield*/, (0, index_1.createReport)({
            ...
            it('treats existing text near nested FOR loops correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, opts, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'nestedInlineForLoopWithSurroundingText.docx'))];
                        case 1:
                            template = _b.sent();
                            opts = {
                                noSandbox: noSandbox,
            ...
            it('newline character inside variable issue #143 not rendered properly in LibreOffice/GDrive', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, headline, opts, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'newlineInVariableIssue143.docx'))];
                        case 1:
                            template = _b.sent();
                            headline = 'I am a line\n\nAnd so am I!';
                            opts = {
                                template: template,
                                data: {
                                    headline: headline,
            ...
            it('Processes FOR loops with Text Box', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'forLoopWithTextBox.docx'))];
                        case 1:
                            template = _a.sent();
                            return [4 /*yield*/, (0, index_1.createReport)({
                                    noSandbox: noSandbox,
            ...
            it('Access current element index from FOR loop', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, opts, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'forWithIdx.docx'))];
                        case 1:
                            template = _a.sent();
                            opts = {
                                noSandbox: noSandbox,
            ...
            it('Nested IF statements on same line', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'ifStatementsOnSameLine.docx'))];
                        case 1:
                            template = _a.sent();
                            result = (0, index_1.createReport)({
                                noSandbox: noSandbox,
                                template: template,
                                data: { a: true, b: true, counts: ['a', 'b', 'c'] },
                                cmdDelimiter: ['{{', '}}'],
                            }, 'JS');
                            return [2 /*return*/, expect(result).rejects.toMatchSnapshot()];
                    }
                });
            }); });
            it('Nested IF statements on same row1', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'ifStatementsOnSameRow1.docx'))];
                        case 1:
                            template = _a.sent();
                            result = (0, index_1.createReport)({
                                noSandbox: noSandbox,
            ...
            it('Nested IF statements on same row2', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'ifStatementsOnSameRow2.docx'))];
                        case 1:
                            template = _a.sent();
                            result = (0, index_1.createReport)({
                                noSandbox: noSandbox,
            ...
            it('Dynamic table columns', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'dynamic-columns.docx'))];
                        case 1:
                            template = _a.sent();
                            return [4 /*yield*/, (0, index_1.createReport)({
                                    noSandbox: noSandbox,
            ...
            it('Dynamic table columns with dynamic rows', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'dynamic-columns-with-dynamic-rows.docx'))];
                        case 1:
                            template = _a.sent();
                            return [4 /*yield*/, (0, index_1.createReport)({
                                    noSandbox: noSandbox,
            ...
            it('Preserve cells when IF evaluates to false inside a column (and the whole column contains just commands) - 1', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'ifInTableWithCommands.docx'))];
                        case 1:
                            template = _a.sent();
                            return [4 /*yield*/, (0, index_1.createReport)({
                                    noSandbox: noSandbox,
            ...
            it('Preserve cells when IF evaluates to false inside a column (and the whole column contains just commands) - 2', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'ifInTableWithCommands.docx'))];
            ...
            it('Preserve cells when IF evaluates to true inside a column', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'ifInTableWithCommands.docx'))];
            ...
            it('Preserves anchored elements on empty paragraph', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'anchor-empty.docx'))];
                        case 1:
                            template = _a.sent();
                            return [4 /*yield*/, (0, index_1.createReport)({
                                    template: template,
            ...
            it('Removes everything within a block that evaluates to false', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'falsy-block.docx'))];
                        case 1:
                            template = _a.sent();
                            return [4 /*yield*/, (0, index_1.createReport)({
                                    template: template,
