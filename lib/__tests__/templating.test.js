...
['noSandbox', 'sandbox'].forEach(function (sbStatus) {
    ...
    describe("".concat(sbStatus), function () {
        describe('Template processing', function () {
            ...
            it('Preserves drawing elements', function () { return __awaiter(void 0, void 0, void 0, function () {
                var template, opts, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fs_1.default.promises.readFile(path_1.default.join(__dirname, 'fixtures', 'anchor.docx'))];
                        case 1:
                            template = _a.sent();
                            opts = {
                                template: template,
