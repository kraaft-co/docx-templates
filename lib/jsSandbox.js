...
function runUserJsAndGetRaw(data, code, ctx) {
    return __awaiter(this, void 0, void 0, function () {
        var isLikelyFunctionCall, result_1, sandbox, curLoop, context, result, temp, wrapper, script, err_1, e, nerr;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    isLikelyFunctionCall = code.includes('(') && code.includes(')');
                    if (isLikelyFunctionCall && data && code in data) {
                        result_1 = data[code];
                        debug_1.logger.debug('Command returned: ', result_1);
