# FOR KRAAFT DEVELOPERS

If you want to patch this library:
- create a branch with your fix
- merge it to master **without** the lib folder
- rebase master into the `build` branch
- build the `build` branch and push
- reference the resulting commit in the package.json in the monorepo
